...
APP_DOMAINS = ['demo100.getechenterprise.com']
...
ON_PROD = ON_GAE and ('grab-n-go-250509' in APPLICATION_ID)
...
ADMIN_EMAIL = 'googlesupport@demo100.getechenterprise.com'

# The email address application emails will come from.
SEND_EMAIL_AS = 'no-reply@demo100.getechenterprise.com'
...
SUPERADMINS_GROUP = 'technical-admins@demo100.getechenterprise.com'

# The PROD server specific configurations.
if ON_PROD:
  # The OAuth2 Client ID for the Chrome Application.
  CHROME_CLIENT_ID = '652450695147-pmmflb06hr7kp8fs4ra78dhol6r8hq6i.apps.googleusercontent.com'
  # The OAuth2 Client ID for the Web Application Frontend.
  WEB_CLIENT_ID = '652450695147-6776otprfu8s6mpiiet1305r7qh69p6s.apps.googleusercontent.com'
