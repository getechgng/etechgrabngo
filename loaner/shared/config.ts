...
export const PROD = 'grab-n-go-250509';

/** The url for the Google Cloud Endpoints API for your application. */
export const WEB_CLIENT_IDS: EnvironmentsVariable = {
  prod: `652450695147-6776otprfu8s6mpiiet1305r7qh69p6s.apps.googleusercontent.com`,
  qa: `{QA_WEB_ID}`,
  dev: `{DEV_WEB_ID}`,
};
...
export const CHROME_PUBLIC_KEYS: EnvironmentsVariable = {
  prod: '',
  qa: '{QA_CHROME_KEY}',
  dev: '{DEV_CHROME_KEY}',
};
